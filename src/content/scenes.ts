...
export const SCENES: readonly SceneDefinition[] = [
  ...
  },
  {
    ...
    lines: [
      "じっとしててね。あと背中をひと往復……うん、さらさらになったキチ！",
      "クーンちゃん、ぴかぴか！ 朝の光で、しま模様までつやつやだね。",
    ],
    details: [
  ...
  },
  {
    ...
    band: "daytime",
    title: "ひなたを半分こ",
    description: "日だまりの中で、マサハルとエトキチがぴったり寄り添って眠っている。",
    lines: ["むにゃ……マサハル、あったかい……", "すー……すー……ひなた、半分こ……"],
    details: [
      "マサハルのふわふわの体に、エトキチがそっと寄りかかっている",
